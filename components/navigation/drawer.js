...
import { HomeStack, PedidoStack } from './stack';
...
function MyDrawer() {
  ...
  const handleLogout = ()=>{
    ...
    name='EstadoCotStack'
    component={''}
    options={{title:'Estado de Cotizacion',drawerIcon:()=><Icon name="toggle-on" size={22} color="black" />}}
    />
    <Drawer.Screen
    ...
    name='CuentasStack'
    component={''}
    options={{title:'Cuentas por Cobrar',drawerIcon:()=><Icon name='toggle-on' size={22}/>}}
    />
    <Drawer.Screen
    name='VentasStack'
    component={''}
